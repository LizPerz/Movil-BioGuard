...
data class LoginGoogleRequest(val idToken: String)
...
data class Verificar2faRequest(val correo: String, val codigoOtp: String)
...
data class AtenderEventoRequest(val notasAtencion: String)
...
data class UpdateCorreoRequest(val nuevoCorreo: String, val password: String)
...
data class CrearMedicamentoRequest(val pacienteId: String, val nombre: String, val dosis: String, val frecuencia: String, val notas: String? = null)
data class CrearMedicamentoResponse(val medicamentoId: String, val message: String)
data class ActualizarMedicamentoRequest(val nombre: String, val dosis: String, val frecuencia: String, val notas: String? = null)
...
data class PlanResponse(
    ...
    val precioMoneda: String? = null,
    val limitePacientes: Int = 0,
    val limiteCuidadores: Int = 0,
    val diasHistorial: Int = 0,
    val gpsContinuo: Boolean = false,
    val aiConsole: Boolean = false,
    val descripcion: String? = null
)
...
// PAGOS
// =============================================
data class CrearSesionPagoRequest(val planNombre: String, val procesador: String)
data class CrearSesionPagoResponse(val pagoId: String, val monto: Double, val moneda: String, val sesionUrl: String)
...
interface ApiService {
    ...
    // =============================================
    @GET("api/Planes")
    suspend fun getPlanes(): List<PlanResponse>

    // =============================================
    // PAGOS
    // =============================================
    @GET("api/Pagos/historial")
    suspend fun getHistorialPagos(): List<PagoResponse>
